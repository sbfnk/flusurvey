...
st15[, suddenly := 1]
st15[is.na(symptoms.suddenly) & is.na(fever.suddenly), suddenly := NA]
st15[is.na(symptoms.suddenly) & fever.suddenly > 0, suddenly := 0]
st15[is.na(fever.suddenly) & symptoms.suddenly > 0, suddenly := 0]
st15[fever.suddenly > 0 & symptoms.suddenly > 0, suddenly := 0]
...
st15[, ili.notired := ((suddenly == 1) &
                       ...
                       (sore.throat == 1 | cough ==1 |
                        shortness.breath == 1))]
st15[, ili.notired := as.integer(ili.notired)]

st15[, ili.fever := ((suddenly == 1) &
                     (fever == 1) &
                     (sore.throat == 1 | cough ==1 |
                      shortness.breath == 1))]
st15[, ili.fever := as.integer(ili.fever)]
